...
The goal of *HDDAData* is to provide easy access from R to datasets used in the High Dimensional
Data Analysis course taught at Ghent University.

## Installation

You can install *HDDAData* from [GitHub](https://github.com/statOmics/HDDAData) with:
